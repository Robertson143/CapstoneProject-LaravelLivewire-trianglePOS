                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="barcode_symbology">Section <span class="text-danger">*</span></label>
                          ...
                          <!-- <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_cost">Expiration Date: <span class="text-danger">*</span></label>
                                        <input id="product_cost" type="date" class="form-control" name="product_cost" required value="{{ old('product_cost') }}">
                                    </div>
                                </div> -->
                           ...
                           <!-- <div class="form-row">
                            ...
                            <div class="form-group">
                                <label for="product_note">Description</label>
