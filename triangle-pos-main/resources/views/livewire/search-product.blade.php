        ...
        <div class="card-body">
            <div class="form-group mb-0">
                <div class="input-group">
                    ...
                    <input wire:keydown.escape="resetQuery" wire:model.debounce.500ms="query" type="text" class="form-control" placeholder="Search Product Name....">
                </div>
            </div>
        </div>
    </div>
                        ...
                        @foreach($search_results as $result)
                            <li class="list-group-item list-group-item-action">
                                <a wire:click="resetQuery" wire:click.prevent="selectProduct({{ $result }})" href="#">
                                  Name: {{ $result->product_name }} | Price: ₱{{ $result->product_price }} {{ $result->product_note }}
                                </a>
                            </li>
                        @endforeach
